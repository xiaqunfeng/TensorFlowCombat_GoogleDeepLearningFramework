...
[TensorFlow_learning_notes](https://github.com/cookeem/TensorFlow_learning_notes)

![Tensorflow实战Google深度学习框架](images/cover.JPEG)

- 在 TensorFlow_learning_notes 的基础上对内容进行了必要的补充，并添加自己的理解。
- 对tensorflow老版本中被遗弃的特性代码进行修正。

> 注：jupyter中代码为python3.x代码。
